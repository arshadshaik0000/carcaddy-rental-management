...
import com.pms.repository.RentBookingRepository;
...
public class RentBookingServiceImpl implements RentBookingService {
        ...
        public Rent_Booking addBooking(Rent_Booking booking) throws InvalidEntityException {
                ...
                Customer customer = customerRepository.findById(booking.getCustomer().getId())
                                .orElseThrow(() -> new InvalidEntityException(
                                                "Customer not found with ID: " + booking.getCustomer().getId()));
        ...
        public Rent_Booking updateBooking(int id, Rent_Booking updatedBooking)
                ...
                Employee employee = employeeRepository.findById(updatedBooking.getEmployee().getEmployeeId())
                                .orElseThrow(() -> new InvalidEntityException(
                                                "Employee not found with ID: "
                                                                + updatedBooking.getEmployee().getEmployeeId()));
                System.out.println(customer.getEmail() + " " + employee.getEmployeeEmail());
                ...
                emailService.sendEmail(employee.getEmployeeEmail(),
                                "Rent " + updatedBooking.getBookingId() + " Updated",
